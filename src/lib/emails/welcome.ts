...
<body style="background:#08080F;color:#F1F0FF;font-family:'Segoe UI',sans-serif;padding:32px;max-width:520px;margin:0 auto;">
  <div style="text-align:center;margin-bottom:28px;">
    <div style="display:inline-block;width:56px;height:56px;background:linear-gradient(135deg,#7C3AED,#9F67FF);border-radius:14px;line-height:56px;font-size:18px;font-weight:bold;color:#fff;text-align:center;">RPG</div>
